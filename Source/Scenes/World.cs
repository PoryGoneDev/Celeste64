...
public class World : Scene
{
    ...
    private readonly Menu checkpointsMenu;
	...
	public World(EntryInfo entry)
	{
		...
		// setup pause menu
		{
			...
			optionsMenu.Add(new Menu.Toggle(Loc.Str("OptionsBackground"), () => Save.Instance.ToggleBackgroundInput(Game), () => Save.Instance.BackgroundInput));
